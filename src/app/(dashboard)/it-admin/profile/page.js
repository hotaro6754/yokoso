...
export default function ITAdminProfilePage() {
    ...
    const fetchProfile = async () => {
        try {
            ...
            // Set mock data for IT Admin
            setProfileData({
                personal: {
                    firstName: 'IT',
                    lastName: 'Admin',
                    email: 'itadmin@globalhr.com',
                    personalEmail: 'it.admin@example.com',
    ...
    const transformApiData = (apiData) => {
        ...
        return {
            personal: {
                firstName: employee.firstName || apiData.firstName || 'IT',
                lastName: employee.lastName || apiData.lastName || 'Admin',
    ...
    return (
        <div className="bg-gradient-to-br from-primary-50/30 via-white to-primary-50/10 min-h-screen dark:from-gray-900 dark:via-gray-900 dark:to-gray-900 p-4 sm:p-6">
            ...
            {/* Add spacing between breadcrumb and profile header */}
            <div className="mt-6">
