...
export default function ComplianceGreetingCard() {
  ...
  return (
    <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-primary-700 to-secondary-600 p-6 text-white shadow-lg">
      ...
      <div className="relative z-10">
        ...
        <div className="flex items-start justify-between mb-6">
          ...
          <div className="flex items-center gap-1.5 px-2.5 py-1.5 bg-white/10 backdrop-blur-sm rounded-lg border border-white/20">
            ...
            <span className="text-xs font-medium text-white/90">{getCurrentDate()}</span>
          </div>
        </div>
