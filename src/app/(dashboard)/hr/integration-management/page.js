...
export default function HRIntegrationManagementPage() {
    ...
    const fetchIntegrations = async () => {
        ...
        try {
            ...
            const all = response.data || response.integrations || response.docs || [];
            // HR only sees biometric integrations
            const data = all.filter(i => i.type === 'BIOMETRIC');
            ...
            <div className="mt-8 flex flex-col md:flex-row gap-6">
                ...
                <div className="flex-1">
                    <div className="flex flex-col sm:flex-row justify-between items-center mb-4 gap-4">
                        <h2 className="text-lg font-bold text-gray-900">Biometric Integrations</h2>
                        <button
                            onClick={() => router.push('/hr/integration-management/add')}
                    ...
                    <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
                        {loading ? (
                            ...
                            <div className="flex flex-col items-center justify-center py-20 text-gray-500">
                                ...
                                <p className="text-lg font-medium">No biometric integrations found</p>
                                <p className="text-sm">Add a new biometric device to get started.</p>
                            </div>
                        ) : (
                                            ...
                                            <tr key={item.id || item._id} className="hover:bg-gray-50 transition-colors">
                                                ...
                                                <td className="px-6 py-4 text-right">
                                                    <div className="flex items-center justify-end gap-2">
                                                        <button
                                                            onClick={() => router.push(`/hr/integration-management/edit/${item.id || item._id}`)}
