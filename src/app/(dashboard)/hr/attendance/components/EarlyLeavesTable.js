  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div className="bg-gradient-to-r from-purple-50 to-purple-100 dark:from-purple-900/20 dark:to-purple-800/20 p-4 rounded-sm border border-purple-200 dark:border-purple-800 flex-grow w-full sm:w-auto">
        ...
        <ExportButtons 
          columns={["employeeName", "employeeId", "date", "standardTime", "checkOut", "earlyDuration", "status"]} 
          rows={records.map((record) => ({
            ...
            standardTime: record.standardEndTime || "18:00",
            checkOut: record.checkOut || "-",
            earlyDuration: record.earlyFormatted || `${record.earlyMinutes || 0} min`,
            status: record.status || "EARLY_LEAVE"
          }))} 
          fileNamePrefix="early-leaves-report" 
        />
      </div>
