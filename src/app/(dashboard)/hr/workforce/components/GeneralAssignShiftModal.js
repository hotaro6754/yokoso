...
import { X, Calendar, CalendarDays, Clock, MapPin, User, Loader2 } from 'lucide-react';
import { toast } from 'react-hot-toast';
import { employeeShiftService } from '@/services/manager-services/employeeShift.service';
import DatePicker from '@/components/common/DatePicker';

export default function GeneralAssignShiftModal({ isOpen, onClose, onSuccess, teamMembers = [] }) {
