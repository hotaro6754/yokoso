...
export default function ManagerNineBoxGridPositionPage() {
  ...
  const handleBackToGrid = () => {
    router.push('/manager/performance-management/nine-box-grid');
  };
        ...
        {filteredEmployees.length > 0 ? (
          ...
          <div className="text-center py-12">
            ...
            <p className="text-gray-500 dark:text-gray-400">
              {searchTerm ? 'No employees match your search criteria.' : 'There are no employees in this Nine-Box position from your team.'}
            </p>
          </div>
        )}
      </div>
