...
export default function ManagerNineBoxGridPage() {
  ...
  const getBoxColor = (performance, potential) => {
    // 9-Box Grid color mapping - retained as semantic colors for the grid itself
  ...
  const handleBoxClick = (row, col) => {
    router.push(`/manager/performance-management/nine-box-grid/${row}/${col}`);
  };
      ...
      <div className="mb-6 flex flex-col gap-4">
        <Breadcrumb
          items={[
            ...
            { label: "Performance", href: "/manager/performance-management" },
            { label: "9-Box Grid", href: "/manager/performance-management/nine-box-grid" },
          ]}
        />
        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-4 border-b border-gray-200 pb-6 dark:border-gray-700">
          ...
          <div className="flex items-center gap-2">
            <button className="inline-flex items-center gap-2 px-4 py-2.5 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-sm hover:bg-gray-50 dark:bg-gray-800 dark:border-gray-600 dark:text-gray-200 dark:hover:bg-gray-700 transition-colors">
              <Download size={16} />
              Export
            </button>
          </div>
