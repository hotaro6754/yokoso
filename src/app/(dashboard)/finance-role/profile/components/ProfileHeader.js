...
export default function ProfileHeader({ profileData }) {
  return (
    <motion.div
      ...
      className="glass-card rounded-2xl premium-shadow border border-border overflow-hidden"
    >
        ...
        <div className="px-4 pb-4 sm:px-6 sm:pb-6">
          <div className="flex flex-col sm:flex-row items-center sm:items-end -mt-16">
            ...
            <motion.div
              ...
              className="relative"
            >
              <div className="w-32 h-32 rounded-full border-4 border-card bg-gradient-to-br from-primary/20 to-accent/20 overflow-hidden shadow-lg flex items-center justify-center">
