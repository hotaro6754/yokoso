    ...
    <div>
      ...
      {isUploading && (
        <motion.div
          ...
          className="glass-card p-4 sm:p-6 rounded-xl border border-border mb-6 shadow-md"
        >
        ...
        {data.length > 0 ? (
          data.map((document, index) => (
            <motion.div
              ...
              className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 p-4 glass-card rounded-xl border border-border shadow-sm"
            >
              <div className="flex items-center">
                <FileText className="text-primary mr-3" size={20} />
                <div>
