...
export default function EditCoursePage() {
  ...
  const fetchCourse = async () => {
    try {
      ...
      setFormData({
        ...
        assessmentIncluded: course.assessmentIncluded || false,
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      setSaving(true);
      await ldService.updateCourse(params.id, formData);
      toast.success("Course updated successfully");
      router.push(`/ld/courses/${params.id}`);
    } catch (error) {
    ...
    <div className="bg-gray-50 min-h-screen dark:bg-gray-900 p-4 sm:p-6">
      <Breadcrumb
        items={[
          ...
          { label: formData.courseTitle, href: `/ld/courses/${params.id}` },
          { label: "Edit", href: `/ld/courses/${params.id}/edit` },
        ]}
      />
