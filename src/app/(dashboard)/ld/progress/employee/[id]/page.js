...
export default function EmployeeProgressDetailPage() {
  ...
  const fetchDetail = async () => {
    try {
      ...
      setDetail(mockDetailWithPerformance);
    } catch (error) {
    ...
    <div className="bg-gray-50 min-h-screen dark:bg-gray-900 p-4 sm:p-6">
      <Breadcrumb
        items={[
          ...
          { label: "Employee-wise", href: "/ld/progress/employee" },
          { label: employee.name, href: `/ld/progress/employee/${params.id}` },
        ]}
      />
