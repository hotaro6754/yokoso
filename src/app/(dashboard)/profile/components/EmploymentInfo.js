...
export default function EmploymentInfo({ data }) {
  ...
  const employmentFields = [
    { 
      icon: Users, 
      iconColor: 'text-brand-600 dark:text-[#E0E2FE]',
    ...
    { 
      icon: Briefcase, 
      iconColor: 'text-purple-600 dark:text-[#E0E2FE]',
    ...
    { 
      icon: Calendar, 
      iconColor: 'text-yellow-600 dark:text-[#E0E2FE]',
    ...
    { 
      icon: Calendar, 
      iconColor: 'text-indigo-600 dark:text-[#E0E2FE]',
    ...
    { 
      icon: MapPin, 
      iconColor: 'text-pink-600 dark:text-[#E0E2FE]',
    ...
    { 
      icon: UserCheck, 
      iconColor: 'text-red-600 dark:text-[#E0E2FE]',
    ...
    { 
      icon: Briefcase, 
      iconColor: 'text-gray-600 dark:text-[#E0E2FE]',
  ...
  return (
    <div>
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 sm:gap-0 mb-6">
        <h2 className="text-lg font-semibold text-gray-800 dark:text-[#E0E2FE]">Employment Information</h2>
        <div className="flex items-center gap-2 px-3 py-1 bg-gray-100 dark:bg-gray-800 rounded-full">
          <Lock size={14} className="text-gray-500 dark:text-[#BBBDEC]" />
          <span className="text-xs text-gray-600 dark:text-[#BBBDEC]">View Only</span>
        </div>
      </div>

      <div className="mb-4 p-3 bg-gray-50 dark:bg-gray-800/50 rounded-lg border border-gray-200 dark:border-gray-700">
        <div className="flex items-start gap-2">
          <Lock size={16} className="text-gray-500 dark:text-[#BBBDEC] mt-0.5 flex-shrink-0" />
          <p className="text-sm text-gray-600 dark:text-[#BBBDEC]">
            ...
            >
              <div className="flex items-center mb-3">
                ...
                <div className="flex-1">
                  <p className="text-sm text-gray-600 dark:text-[#BBBDEC]">{field.label}</p>
                  <p className="font-semibold text-gray-800 dark:text-[#E0E2FE] break-words">
                    {field.value || 'Not specified'}
                  </p>
                  {field.description && (
                    <p className="text-xs text-gray-500 dark:text-[#BBBDEC] mt-1">
                      {field.description}
                    </p>
                  )}
                </div>
