// src/app/(dashboard)/recruiter/profile/components/ProfileHeader.js
"use client";
      ...
      <div className="relative">
        ...
        <div className="px-4 pb-4 sm:px-6 sm:pb-6">
          <div className="flex flex-col sm:flex-row items-center sm:items-end -mt-16">
            {/* Profile Photo */}
            <div className="relative">
              <div className="w-32 h-32 rounded-full border-4 border-white dark:border-gray-800 bg-gray-200 dark:bg-gray-700 overflow-hidden flex items-center justify-center">
              ...
              <button className="absolute bottom-2 right-2 p-2 bg-primary-600 text-white rounded-full hover:bg-primary-700 transition">
                <Camera size={16} />
              </button>
            </div>
